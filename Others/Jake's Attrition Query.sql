USE grp_gdoop_bizops_db;create TEMPORARY table jk_booking_solution as 
    select o2.deal_uuid,
...
select * from grp_gdoop_bizops_db.jk_booking_solution;
 
create temporary table booking_scope_deals as 
select t.deal_uuid,to_date(dw.week_end)  as week_end_date,date_sub(to_date(dw.week_end) , 7) previous_week,date_add(to_date(dw.week_end ), 7) next_week,
...
) as adds on live.week_end_date = adds.week_end_date and live.region = adds.region and live.l1 = adds.l1 
		and live.l2 = adds.l2 and live.l3 = adds.l3 and live.current_booking_solution = adds.current_booking_solution 
left join (select
...
) lost on live.week_end_date = lost.week_end_date and live.region = lost.region and live.l1 = lost.l1 
		and live.l2 = lost.l2 and live.l3 = lost.l3 and live.current_booking_solution = lost.current_booking_solution 	
