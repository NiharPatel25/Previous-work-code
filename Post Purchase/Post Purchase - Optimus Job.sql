...
where 
	...
	and cast(b.start_time as date) between '2020-09-01' and current_date - 1;drop table us_reds;
...
select * from sandbox.nvp_ns_merchant_lastlog;
-------------------------------------------------------------------------------------------------------step 7
...
select distinct country_id from sandbox.ab_chkins_final_agg;
...
where appointment_week = '2020-08-30'
and country_id = 'AU'
group by 1,2,3
order by 1,2,3
;
...
select 
    sum(bookings)
from sandbox.ab_chkins_final_agg 
where appointment_week = '2021-01-24'
and country_id = 'AU'
;



from sandbox.ab_chkins_final_agg where country_id = 'AU';
